-- Création automatique du profil à l'inscription (fonctionne même sans session active)
...
BEGIN
  ...
  VALUES (p_user_id, COALESCE(NULLIF(trim(p_display_name), ''), 'Utilisateur'), p_space_type, v_couple_id)
...
GRANT EXECUTE ON FUNCTION complete_profile_for_user(UUID, TEXT, space_type) TO service_role;
